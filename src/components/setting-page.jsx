            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1 flex justify-center lg:justify-start pt-8">
                <div className="relative">
                  ...
                  <div className="absolute bottom-1-right-1 w-6 h-6 bg-white rounded-full flex items-center justify-center border border-gray-300 shadow-sm cursor-pointer">
